...
valid_cat2 = cat2_counts[cat2_counts >= 0].index.tolist()
...
valid_cat2_filtered = valid_cat2_filtered[valid_cat2_filtered >= 0].index.tolist()
...
if use_bbox and not df_filtered.empty:
    # Ensure numeric coords
    df_filtered["Latitude"] = pd.to_numeric(df_filtered["Latitude"], errors="coerce")
    df_filtered["Longitude"] = pd.to_numeric(df_filtered["Longitude"], errors="coerce")
    df_geo = df_filtered.dropna(subset=["Latitude", "Longitude"]).copy()
